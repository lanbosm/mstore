...
u.testPromiseResolve = function (delay, data) {
  // 20ms 后去 resolve
  var delay = delay || 300
  var msg = data ||{msg: '响应成功'}
  return new Promise((resolve, reject) => {
    setTimeout(() => { resolve(msg) }, delay)
  })
}

u.testPromiseReject = function (delay, data) {
  // 20ms 后去 resolve
  var delay = delay || 300
  var msg =  data||{msg: '响应成功'}
  return new Promise((resolve, reject) => {
    setTimeout(() => { reject(msg) }, delay)
  })
}

u.loadScript = function (url, completeCallback) {
