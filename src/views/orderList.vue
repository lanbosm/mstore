                 ...
                 <li class="item_li" v-for="(item,index) in data" @click="pagePush('/orderDetail/'+item.sn)">
                    ...
                    <div class="item_li_content mg-t-20">
                        <div class="item_img" :style="{backgroundImage:'url('+item.orderImg+')'}">
                            <!-- <img src="//origin.dorodoro-lab.com/static/images/test.jpg" alt=""> -->
                        </div>
...
export default {
  ...
  methods:{
    fetchData(){
       var list0={
         data:[
           {sn:'845643513556464534351',status:'等待收货',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
           {sn:'845643513556464534351',status:'已送达',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
           {sn:'845643513556464534351',status:'收货成功',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
           {sn:'845643513556464534351',status:'已过期',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
           {sn:'845643513556464534351',status:'等待收货',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
         ],
         moredata:[]
       };
       var list1={
         data:[
           {sn:'845643513556464534351',status:'待付款',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
           {sn:'845643513556464534351',status:'待付款',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
           {sn:'845643513556464534351',status:'待付款',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
           {sn:'845643513556464534351',status:'待付款',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
           {sn:'845643513556464534351',status:'待付款',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
       ...
       var list2={
         data:[
           {sn:'845643513556464534351',status:'待发货',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
           {sn:'845643513556464534351',status:'待发货',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
         ],
         moredata:[]
       };
       var list3={
         data:[
           {sn:'845643513556464534351',status:'待收货',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
           {sn:'845643513556464534351',status:'待收货',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
         ],
         moredata:[]
       };
       var list4={
         data:[
           {sn:'845643513556464534351',status:'待评价',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
           {sn:'845643513556464534351',status:'待评价',orderImg:'//origin.dorodoro-lab.com/static/images/test.jpg',orderName:'毛衣',spec:'一件（XL码）*2',orderPrice:'300'},
         ],
         moredata:[]
       };
